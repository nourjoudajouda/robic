<x-guest-layout>
    <div class="authentication-wrapper authentication-cover">
        ...
        <a href="{{ route('dashboard') }}" class="auth-cover-brand d-flex align-items-center gap-2">
            ...
            <span class="app-brand-text demo text-heading fw-semibold">{{ config('app.name', 'Materialize') }}</span>
        </a>
        <!-- /Logo -->
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
                <img
                    src="{{ asset('admin-dashboard/assets/img/illustrations/auth-login-illustration-light.png') }}"
                ...
                <img
                    alt="mask"
                    src="{{ asset('admin-dashboard/assets/img/illustrations/auth-basic-login-mask-light.png') }}"
